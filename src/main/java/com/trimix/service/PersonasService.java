...
public class PersonasService {
	...
	/*
	static {
		personasDB.add(new Persona(1, "Pratto", "Oso", 9122018,"DNI", new Date()));
		personasDB.add(new Persona(1, "Quinteroooooooo", "Juanfer", 9122018,"Pasaporte", new Date()));
		personasDB.add(new Persona(1, "Martinez", "Que loco que esta", 9122018,"Cedula", new Date()));
	}
	 */
